...
#define RAD_TX_MSG_TYPE_RAD_START_PULSE_LEN_PWM_VALUES (RAD_MSG_TYPE_RAD_START_PULSE_LEN_US / \
...
#define RAD_TX_MSG_TYPE_RAD_MAX_MSG_LEN_PWM_VALUES     (RAD_TX_MSG_TYPE_RAD_START_PULSE_LEN_PWM_VALUES + \
