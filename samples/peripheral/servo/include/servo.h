...
// The chX_pins can be set to any GPIO or set to SERVO_PIN_NOT_USED if the channel
// is not required.
...
// Returns NRFX_ERROR_INVALID_PARAM if the given ch_index is not assigned to a
